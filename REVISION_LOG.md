...
На дату 2026-08-20 выполнена базовая SEO-оптимизация главной страницы и добавлены технические файлы для поисковых систем. На дату 2026-08-18 выполнено обновление дизайна и функциональности сайта Синтегра 3D. Изменения затронули:
...
### 14. `img/logo-removebg-preview.png` (новый файл)
...
### 15. `img/hbd-p400-removebg-preview.png` (новый файл)
...
### 16. `index.html`, `printing.html`, `equipment.html` — исправление атрибутов изображений
...
### 17. `index.html` — исправление адреса Яндекс Карт
...
### 18. `printing.html` — восстановление стилей под единый стандарт
